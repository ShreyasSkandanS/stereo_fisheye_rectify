...
void rectifyCallback(const sensor_msgs::ImageConstPtr& cam_l_msg, const sensor_msgs::ImageConstPtr& cam_r_msg)
{
...
int main(int argc, char **argv)
{
  ...
  message_filters::Synchronizer<syncPolicy> sync(syncPolicy(10), image_sub_1, image_sub_2);
	sync.registerCallback(boost::bind(&rectifyCallback, _1, _2));
